...
export function CreateIssueDialog({ projectId, projectMembers, trigger, onSuccess }: CreateIssueDialogProps) {
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, assignee_id: value || undefined }))}
                >
